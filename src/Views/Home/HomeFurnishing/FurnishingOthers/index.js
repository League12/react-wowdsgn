...
class FurnishingOthers extends React.Component {
    render() {
        return (
            <div className={css.furnishingOthers}>
    ...
    handlePClick() {
        this.props.history.push(`/querylist/${this.props.queryListId}`);
    }
}

export default FurnishingOthers;
